...
- [Background](#background)
  - [What the hybrid looks like today](#what-the-hybrid-looks-like-today)
  - [What IMPL-0004 already decided (OQ-6)](#what-impl-0004-already-decided-oq-6)
  - [What's actually HCL inside the YAML today](#whats-actually-hcl-inside-the-yaml-today)
- [Detailed Design](#detailed-design)
  - [Target shape — blueprint.hcl + registry.hcl](#target-shape--blueprinthcl--registryhcl)
  - [apiVersion handling](#apiversion-handling)
