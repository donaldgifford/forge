...
// TestRenderer_HelmStyleSurvival is the critical fixture per IMPL-0004
...
func TestRenderer_HelmStyleSurvival(t *testing.T) {
	t.Parallel()
...
func TestRenderer_RenderFile_NotFound(t *testing.T) {
	t.Parallel()
...
func TestRenderer_EvaluateBool(t *testing.T) {
	t.Parallel()
...
// TestRenderer_DiagnosticErrorIncludesSource verifies that parse errors
// surface with file/line/column information from hcl.Diagnostics, satisfying
// IMPL-0004 A.4's diagnostics requirement.
func TestRenderer_DiagnosticErrorIncludesSource(t *testing.T) {
	t.Parallel()
...
func TestRenderer_CustomFuncs(t *testing.T) {
	t.Parallel()
...
func TestRenderer_NowAndEnv(t *testing.T) {
	r := tmpl.NewRenderer()
